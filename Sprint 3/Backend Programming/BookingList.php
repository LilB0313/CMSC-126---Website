    ...
    <div class="container">
      ...
      <?php
        ...
        if (isset($_POST['is_vacant'])) {
          ...
          $sql = "SELECT StayDate, Set_Type
                  FROM booking
                  WHERE StayDate BETWEEN '$from_date' AND '$to_date'
                  ORDER BY StayDate";
          ...
          if ($displayBooking -> num_rows > 0) {
            ...
            while ($showBooking = $displayBooking -> fetch_assoc()) {
              $set_type = $showBooking["Set_Type"];
              $query = "SELECT StayType
                      FROM stay_type
              ...
              echo "<tr>".
                "<td>".$showBooking["StayDate"]."</td>".
                "<td>".$showStayType["StayType"]."</td>".
              "</tr>";
            }
